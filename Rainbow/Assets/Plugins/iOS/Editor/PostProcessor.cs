    ...
    public static class PostProcessor {
        ...
        public static void OnPostProcessBuild(BuildTarget buildTarget, string buildPath) {
            if(buildTarget == BuildTarget.iOS) {
				...
				proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_BRIDGING_HEADER", "Libraries/AdBrixRm_iOS/AdBrixRmKit-Bridging-Header.h");
				proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_INTERFACE_HEADER_NAME", "AdBrixRmKit-Swift.h");
				...
				const string coreFrameworkName = "AdBrixRmKit.framework";
